const textArea = document.querySelector(".textArea__1"); // Variable almacena informacion introducida
const mensaje = document.querySelector(".textArea__2"); // Variable almacena informacion ya encriptada 
